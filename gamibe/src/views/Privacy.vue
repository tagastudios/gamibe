<template>
    ...
    <ul>
        ...
        <li>
            <p>
                <strong>Application</strong> refers to Gamibe, the software program provided by the
                Company.
            </p>
        </li>
        <li>
            <p>
                ...
                &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Taga
                Studios LLC, 13100 Heather Moss Dr #802, Orlando, FL 32837.
            </p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: tagastudios@gmail.com</li>
    </ul>
</template>
